...
async function beginGeneration() {
    ...
    // (Ian)
    // The QRCode should contain:
    //  * The user's public/private keypair (elliptic curve)
    //  * The *unblinded* signature of the public key generated by the server
    //
    // Suggestion: In JavaScript put these in an object and serialize to binary then convert
    //             to base64 before giving it to QRCode() to render as a QRCode
